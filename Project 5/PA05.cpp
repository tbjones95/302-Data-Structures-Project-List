...
void displayList( const SorterClass<DateType> &dates, 
 ...
 * @param in: identifying letter to be displayed
 * @param in: indication of sorted list
 *
 * @note displays any subclass of SorterClass
 */
